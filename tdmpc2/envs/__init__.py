...
try:
    from tdmpc2.envs.torchdriveenv import make_env as make_torchdriveenv_env
except:
    make_torchdriveenv_env = missing_dependencies
try:
    from tdmpc2.envs.waypointvecenv import make_env as make_waypointvec_env
except:
    make_waypointvec_env = missing_dependencies
