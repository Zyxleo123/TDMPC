...
class PixelWrapper(gym.Wrapper):
    ...
    def _get_obs(self):
        #print("env", self.env.name)##
        frame = self.env.render(
           #mode="rgb_array", width=self._render_size, height=self._render_size #TODO: fix this for rgb input, should be commented out for driveenv
        ).transpose(2, 0, 1)
